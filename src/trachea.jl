...
struct straightTube
    ...
    function straightTube(T, ro, Q, mu, ro_d, d_d, d, phi, L)
        extrapl = 0;
        K = 5e-5;                               # K is obtained via regression to fit experimental results for very small drops (Brownian effect)
...
ro = 1.141 # Estimate from Engineering toolbox
...
# Q = 0.00034
Q = 0.00050038
mu = 1.825e-5 # Dynamic viscosity of air (https://www.engineersedge.com/physics/viscosity_of_air_dynamic_and_kinematic_14483.htm#:~:text=The%20viscosity%20of%20air%20depends,10%2D5%20Pa%C2%B7s%20.&text=At%2025%20%C2%B0C%2C%20the,the%20kinematic%20viscosity%2015.7%20cSt.)
ro_d = 1000 # Droplet density of water
d_d = 3e-6 # droplet diameter of inhalation
